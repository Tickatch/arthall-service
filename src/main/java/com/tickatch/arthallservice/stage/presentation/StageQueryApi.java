...
public class StageQueryApi {
  ...
  public ApiResponse<StageDetailResponse> getDetail(@PathVariable Long stageId) {

    Stage stage = stageQueryService.getStageDetail(stageId);

    return ApiResponse.success(StageDetailResponse.from(stage));
  }
  ...
  public ApiResponse<PageResponse<StageListResponse>> getList(
    ...
    return ApiResponse.success(PageResponse.from(page, StageListResponse::from));
  }
}
