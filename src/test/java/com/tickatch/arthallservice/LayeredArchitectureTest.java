package com.tickatch.arthallservice;
...
@AnalyzeClasses(
    packages = "com.tickatch.arthallservice",
    importOptions = ImportOption.DoNotIncludeTests.class)
class LayeredArchitectureTest {

  private static final String[] DOMAIN_PACKAGES = {
    "com.tickatch.arthallservice.arthall.domain..", "com.tickatch.arthallservice.stage.domain.."
  };
  ...
  public void layeredArchitecture(JavaClasses classes) {
    Architectures.layeredArchitecture()
        ...
        .layer("Presentation")
        .definedBy("com.tickatch.arthallservice..presentation..")
        .layer("Application")
        .definedBy("com.tickatch.arthallservice..application..")
        .layer("Domain")
        .definedBy("com.tickatch.arthallservice..domain..")
        .layer("Infrastructure")
        .definedBy("com.tickatch.arthallservice..infrastructure..")
        ...
        .ignoreDependency(
            ...
            JavaClass.Predicates.resideInAPackage("com.tickatch.arthallservice.global.."))
        // 빈 레이어 허용
  ...
  public void globalShouldNotDependOnDomains(JavaClasses classes) {
    ...
    // global 패키지가 없으면 스킵
    if (!hasClassesInPackage(classes, "com.tickatch.arthallservice.global..")) {
      return;
    }

    noClasses()
        .that()
        .resideInAPackage("com.tickatch.arthallservice.global..")
        .should()
        .dependOnClassesThat()
